...
const CATALOG_ACHIEVEMENT_COPY = {
  ...
  "model-sunset": { title: "Undead Uptime", description: "First Zombie Model Farm. Retired models still bill." },
  "memory-redaction": { title: "Recall Everything", description: "First Total Recall Mandate. Every memory reprocessed." },
  ...
  "hex-sunset": { title: "Cursed Redline", description: "First Hexed Overclock Rite. Models run hot forever." },
  ...
  "abyss-gateway": { title: "Hole Opened", description: "First Abyss Gateway Protocol. Bottomless compute tapped." },
  "entropy-rite": { title: "Harvest Cascade", description: "First Entropy Harvest Cascade. Decay becomes tokens." },
};
