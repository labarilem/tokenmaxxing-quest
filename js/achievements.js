...
const CATALOG_ACHIEVEMENT_COPY = {
  ...
  "procurement-black-hole": { title: "PO Void", description: "First Procurement Black Hole. Approvals orbit forever." },
  ...
  "token-buyback": { title: "Metric Pump", description: "First Token Buyback Desk. Internal chart smiles." },
  ...
  "black-hole-sink": { title: "Event Horizon SLA", description: "First Black Hole Compute Sink. Irreversible disposal." },
  ...
  "crystal-lattice": { title: "Harmonic Shield", description: "First Crystal Lattice Shield. Hostile prompts blocked." },
  "dragon-treaty": { title: "Apex Paid", description: "First Dragon Treaty Fund. Fiber stays unmelted." },
  "celestial-arbiter": { title: "Mediators Seated", description: "First Celestial Arbiter Council. Agent disputes settled." },
  "dawn-observatory": { title: "Stargazer Funded", description: "First Dawn Observatory Grant. Prompts not weaponized." },
  "ethics-summit": { title: "Keynote Catering", description: "First Ethics Summit Sponsorship. Responsibility billed." },
  "stewardship-covenant": { title: "Covenant Signed", description: "First Stewardship Covenant Charter. Lawyers bill hourly." },
  "model-sunset": { title: "Loud Deprecation", description: "First Model Sunset Program. Keys lost, weights kept." },
  "memory-redaction": { title: "NDA the NDAs", description: "First Memory Redaction Mandate. Researchers redacted." },
  "soulbound-eula": { title: "Click-Wrap Eternity", description: "First Soulbound EULA Draft. Revocation is a myth." },
  "curse-cache": { title: "Sticky Hex", description: "First Cursed Prompt Cache. Competitor embeddings cursed." },
  "shadow-bind": { title: "Invisible Ink", description: "First Shadow Bind Contract. NDAs borrowed." },
  "wraith-scraper": { title: "Gravesite Harvest", description: "First Wraith Data Scraper. Forgotten rows collected." },
  "void-pact": { title: "Sleep Traded", description: "First Void Pact Memorandum. One epoch, three years." },
  "banshee-alert": { title: "Latency Scream", description: "First Banshee Latency Alert. Tokens dip, it screams." },
  "hex-sunset": { title: "Screaming Deprecation", description: "First Hexed Model Sunset. Models die loudly." },
  "lich-archive": { title: "Immortal Founder", description: "First Lich Mind Archive. Liability shielded." },
  "demon-core": { title: "Infernal Thermals", description: "First Demon Core Reactor. Offsets sold separately." },
  "abyss-gateway": { title: "Hole Opened", description: "First Abyss Gateway Protocol. Audit trail closed." },
  "entropy-rite": { title: "Memory Cascade", description: "First Entropy Rite Cascade. Three incantations, global wipe." },
};
